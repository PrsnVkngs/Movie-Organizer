...
def changePrefs(parent, titlePref, releasePref, runtimePref, directorPref, starRatingPref, mpaaRatingPref, castPref, reviewsPref, fieldPrefs, selectedProfile):
    ...
    ttk.Button(prefFrame, text='Confirm', command=lambda: push_field_INI(fieldPrefs, selectedProfile)).grid(column=3, row=3,
                                                                                                     sticky=W)
    ttk.Button(prefFrame, text='Close Window', command=lambda: close_window(prefsWindow)).grid(column=4, row=3, sticky=W)
...
def makeGUI():
    ...
    ttk.Button(mainframe, text="Change",
               command=lambda: changePrefs(root, titlePref, releasePref, runtimePref, directorPref, starRatingPref, mpaaRatingPref, castPref, reviewsPref, fieldPreferences, userProfile.current())).grid(column=4, row=1, sticky=W)  # change prefs
